...
#--------------------------发布内容----------------------------
        ...
        self.vel_pub = rospy.Publisher("/car1/ackermann_steering_controller/cmd_vel", Twist, queue_size=1)
        self.vel_pub = rospy.Publisher("/car2/ackermann_steering_controller/cmd_vel", Twist, queue_size=1)
        self.vel_pub = rospy.Publisher("/car3/ackermann_steering_controller/cmd_vel", Twist, queue_size=1)
        ...
        self.velodyne = rospy.Subscriber(
            "/car2/velodyne/velodyne_points", PointCloud2, self.velodyne_callback, queue_size=1
        )
        self.odom = rospy.Subscriber(
            "/car2/odom_gazebo", Odometry, self.odom_callback, queue_size=1
        )        
        self.velodyne = rospy.Subscriber(
            "/car3/velodyne/velodyne_points", PointCloud2, self.velodyne_callback, queue_size=1
        )
        self.odom = rospy.Subscriber(
            "/car3/odom_gazebo", Odometry, self.odom_callback, queue_size=1
        )
