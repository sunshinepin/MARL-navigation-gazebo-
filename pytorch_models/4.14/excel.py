...
file_path = '/home/xzh/MYHTD/pytorch_models/4.14/80.txt'
excel_file_path = '/home/xzh/MYHTD/pytorch_models/4.14/data.xlsx'
# 新图像保存路径
combined_image_path = '/home/xzh/MYHTD/pytorch_models/4.14/rewards_and_collision_rates.png'
# 单独的奖励和碰撞率图像保存路径
rewards_plot_path = '/home/xzh/MYHTD/pytorch_models/4.14/rewards_plot.png'
collision_rate_plot_path = '/home/xzh/MYHTD/pytorch_models/4.14/collision_rate_plot.png'
...
with open(file_path, 'r') as file:
    for line in file:
        # 检查行是否包含平均奖励信息
        if "Average Reward over 10 Evaluation Episodes" in line:
